      ...
      <nav className="flex fixed  bg-white w-full border-b  space-x-3  z-40  justify-between p-5  items-center  dark:bg-black ">
        <div className=" flex justify-between space-x-5 ">
          <button
            ...
            className=" p-1.5 rounded-full md:hidden hover:bg-zinc-200"
          >
            <IoReorderThree className=" text-2xl text-black  "></IoReorderThree>
          </button>

          <Link
            href="/"
            className=" flex items-center text-black space-x-1 font-extrabold"
          >
        ...
        <div className="flex max-sm:justify-end  justify-between space-x-5 items-center max-lg:grow max-sm:grow ">
          <div className=" sm:w-3/4 transition-all sm:mx-auto    ">
            ...
            sm:bg-slate-100 text-slate-800 hover:text-slate-950 hover:bg-slate-200  "
            >
        ...
        <DropdownMenu.Root>
          ...
          <DropdownMenu.Portal>
            <DropdownMenu.Content
              sideOffset={5}
              className="cursor-pointer min-w-[220px] border bg-white rounded-md p-[5px]  will-change-[opacity,transform] data-[side=top]:animate-slideDownAndFade data-[side=right]:animate-slideLeftAndFade data-[side=bottom]:animate-slideUpAndFade data-[side=left]:animate-slideRightAndFade"
            >
              {" "}
              <DropdownMenu.Item className="text-[13px] leading-none rounded-[3px] flex space-x-2 items-center h-[50px] px-[5px] relative pl-[25px] select-none outline-none data-[disabled]:text-cyan-800 data-[disabled]:pointer-events-none data-[highlighted]:bg-slate-100">
              ...
              <Link href="/api/auth/signout">
                <DropdownMenu.Item className="text-[13px] leading-none rounded-[3px] flex items-center h-[25px] px-[5px] relative pl-[25px] select-none outline-none data-[disabled]:text-zinc-200 data-[disabled]:pointer-events-none data-[highlighted]:bg-slate-100 space-x-1">
                ...
                <DropdownMenu.SubTrigger className="text-[13px] leading-none rounded-[3px] flex items-center h-[25px] px-[5px] relative pl-[25px] select-none outline-none data-[disabled]:text-cyan-800 data-[disabled]:pointer-events-none data-[highlighted]:bg-slate-100">
                  ...
                  <DropdownMenu.Portal>
                    <DropdownMenu.SubContent
                      className="cursor-pointer min-w-[220px] bg-white  border rounded-md p-[5px]  will-change-[opacity,transform] data-[side=top]:animate-slideDownAndFade data-[side=right]:animate-slideLeftAndFade data-[side=bottom]:animate-slideUpAndFade data-[side=left]:animate-slideRightAndFade"
                      sideOffset={3}
                      alignOffset={-5}
                    >
                      <DropdownMenu.Item className=" group text-[13px] leading-none rounded-[3px] flex items-center h-[25px] px-[5px] relative pl-[25px] select-none outline-none data-[disabled]:text-cyan-800 data-[disabled]:pointer-events-none hover:bg-slate-100">
                        english
                      </DropdownMenu.Item>
                      <DropdownMenu.Item className=" group text-[13px] leading-none rounded-[3px] flex items-center h-[25px] px-[5px] relative pl-[25px] select-none outline-none data-[disabled]:text-cyan-800 data-[disabled]:pointer-events-none hover:bg-slate-100">
                        persian
